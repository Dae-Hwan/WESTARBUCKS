# Generated by Django 3.2 on 2021-04-25 14:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nutritions', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='products.nutritions')),
            ],
            options={
                'db_table': 'products',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image_url', models.CharField(default='', max_length=2000)),
